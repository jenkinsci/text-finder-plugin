...
https://ci.jenkins.io/job/Plugins/job/text-finder-plugin/job/master/[image:https://ci.jenkins.io/buildStatus/icon?job=Plugins%2Ftext-finder-plugin%2Fmaster[Build Status]]
